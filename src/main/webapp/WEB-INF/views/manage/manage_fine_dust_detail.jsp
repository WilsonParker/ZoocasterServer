		...
		<div class="table-responsive">
			<form id="frm" method="post" enctype="multipart/form-data">
				...
				<tr>
					...
					<td><%=vo.getBackground_img_path()%></td>
				</tr>
				<tr>
					<td><%=DataStorage.Database.Column.COLUMN_BACKGROUND_NAME%></td>
					<td><%=vo.getBackground_img_name()%></td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						%>
						<img class="img-thumbnail" name="<%=DataStorage.Param.PARAM_BACKGROUND%>" src="<%=DataStorage.Server.PATH_UPLOAD_DIR + vo.getBackground_img_path() + vo.getBackground_img_name()%>" />	
					</td>
				</tr>
				<tr>
					<td><%=DataStorage.Database.Column.COLUMN_CHARACTER_PATH%></td>
					<td><%=vo.getCharacter_img_path()%></td>
				</tr>
				<tr>
					<td><%=DataStorage.Database.Column.COLUMN_CHARACTER_NAME%></td>
					<td><%=vo.getCharacter_img_name()%></td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						%>
						<img class="img-thumbnail" name="<%=DataStorage.Param.PARAM_CHARACTER%>" src="<%=DataStorage.Server.PATH_UPLOAD_DIR + vo.getCharacter_img_path() + vo.getCharacter_img_name()%>" />	
					</td>
				</tr>
				<tr>
					<td><%=DataStorage.Database.Column.COLUMN_EFFECT_PATH%></td>
					<td><%=vo.getEffect_img_path()%></td>
				</tr>
				<tr>
					<td><%=DataStorage.Database.Column.COLUMN_EFFECT_NAME%></td>
					<td><%=vo.getEffect_img_name()%></td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						%>
						<img class="img-thumbnail" name="<%=DataStorage.Param.PARAM_EFFECT%>" src="<%=DataStorage.Server.PATH_UPLOAD_DIR + vo.getEffect_img_path() + vo.getEffect_img_name()%>" />
					</td>
				</tr>
				<tr>
