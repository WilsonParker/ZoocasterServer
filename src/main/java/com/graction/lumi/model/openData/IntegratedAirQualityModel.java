package com.graction.lumi.model.openData;
...
private double coValue			// 일산화탄소 농도  (단위 : ppm)
				...
				, pm10Value		// 미세먼지 (PM10) 농도  (단위 : ㎍/m³)
				, pm10Value24	// 미세먼지 (PM10) 24시간 예측 이동 농도 (단위 : ㎍/m³)
				, pm25Value		// 미세먼지 (PM25) 농도  (단위 : ㎍/m³)
				, pm25Value24	// 미세먼지 (PM25) 24시간 예측 이동 농도 (단위 : ㎍/m³)
				, so2Value		// 아황산가스 농도 (단위 : ppm)
				;
private int coGrade
			, khaiGrade			// 통합환경대기지수
...
@Override
public String toString() {
	return "IntegratedAirQualityModelItem [_returnType=" + _returnType + ", dateTerm=" + dateTerm
			+ ", dataTime=" + dataTime + ", mangName=" + mangName + ", resultCode=" + resultCode
			+ ", resultMsg=" + resultMsg + ", sidoName=" + sidoName + ", stationName=" + stationName
			+ ", coValue=" + coValue + ", khaiValue=" + khaiValue + ", o3Value=" + o3Value + ", pm10Value="
			+ pm10Value + ", pm10Value24=" + pm10Value24 + ", pm25Value=" + pm25Value + ", pm25Value24="
			+ pm25Value24 + ", so2Value=" + so2Value + ", coGrade=" + coGrade + ", khaiGrade=" + khaiGrade
			+ ", noGrade=" + noGrade + ", pm10Grade=" + pm10Grade + ", pm10Grade1h=" + pm10Grade1h
			+ ", pm25Grade=" + pm25Grade + ", pm25Grade1h=" + pm25Grade1h + ", so2Grade=" + so2Grade
			+ ", stationCode=" + stationCode + ", totalCount=" + totalCount + ", rnum=" + rnum + ", pageNo="
			+ pageNo + "]";
}
