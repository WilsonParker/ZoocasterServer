...
*/	
	...
	private WeatherModel bindWeatherModelData(WeatherModel weatherModel, ImageModel imageModel) {
		weatherModel.getImageModel().setBackground_img_name(imageModel.getBackground_img_name());
		weatherModel.getImageModel().setBackground_img_path(imageModel.getBackground_img_path());
		weatherModel.getImageModel().setCharacter_img_name(imageModel.getCharacter_img_name());
		weatherModel.getImageModel().setCharacter_img_path(imageModel.getCharacter_img_path());
		weatherModel.getImageModel().setEffect_img_name(imageModel.getEffect_img_name());
		weatherModel.getImageModel().setEffect_img_path(imageModel.getEffect_img_path());
