...
public class RegionReservationTable {
	...
	private String regionReservation_state
					...
					;
	private Timestamp regionReservation_set_time
					, regionReservation_active_time
					, regionReservation_end_time;

	public RegionReservationTable() {
		
	}
	
	public RegionReservationTable(int regionReservation_background_ref_file_index,
			int regionReservation_character_ref_file_index, int regionReservation_effect_ref_file_index,
			String regionReservation_region, String regionReservation_prioritization, Timestamp regionReservation_set_time,
			Timestamp regionReservation_active_time, Timestamp regionReservation_end_time) {
	...
	public RegionReservationTable(int regionReservation_index, int regionReservation_background_ref_file_index,
			int regionReservation_character_ref_file_index, int regionReservation_effect_ref_file_index,
			String regionReservation_region, String regionReservation_prioritization, Timestamp regionReservation_set_time,
			Timestamp regionReservation_active_time, Timestamp regionReservation_end_time) {
	...
	public Timestamp getRegionReservation_set_time() {
		return regionReservation_set_time;
	}

	public void setRegionReservation_set_time(Timestamp regionReservation_set_time) {
		this.regionReservation_set_time = regionReservation_set_time;
	}

	public Timestamp getRegionReservation_active_time() {
		return regionReservation_active_time;
	}

	public void setRegionReservation_active_time(Timestamp regionReservation_active_time) {
		this.regionReservation_active_time = regionReservation_active_time;
	}

	public Timestamp getRegionReservation_end_time() {
		return regionReservation_end_time;
	}

	public void setRegionReservation_end_time(Timestamp regionReservation_end_time) {
		this.regionReservation_end_time = regionReservation_end_time;
	}
