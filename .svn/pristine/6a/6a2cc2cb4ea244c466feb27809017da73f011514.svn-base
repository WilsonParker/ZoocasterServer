...
public class DataParser {
	...
	public <T> T dataBinding(HttpServletRequest request, T t) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, InstantiationException {
	...
	public <T> T dataBinding(HttpServletRequest request, Class<?> cls) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, InstantiationException {
		return dataBinding(request, (T) cls.newInstance());
	}
